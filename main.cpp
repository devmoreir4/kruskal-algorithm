...
//algoritmo Union-Find que detecta ciclos em grafos NAO direcionados.
#include <iostream>
#include <vector>
...
public:
	...
	// buscar o subconjunto de um elemento "i"
	...
	// unir dois subconjuntos em um unico subconjunto
	...
	void kruskal()
	{
		...
		// inicializa todos os subconjuntos como conjuntos de um unico elemento
		...
		for(int i = 0; i < size_arestas; i++)
		{
			...
			if(v1 != v2)
			{
				// se forem diferentes entao nao forma ciclo, insere no vetor
				arvore.push_back(arestas[i]);
				unir(subset, v1, v2); // faz a uniao
			}
		}
